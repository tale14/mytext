	...
	<body>
		...
		<div class = "content">
			<div class = "left-div">
				...
				<h3 style = "text-align:center">班级信息删除界面</h3>	
			<div class = "center-div">
				<form action = "Servlet_del" method = "post">
					<table class = "center-table">
						<tr>	
							<td>学生姓名:
							<input type = "text" name = "studentName"></td>
						</tr>
						<tr>
							<td>班级名称:
						...
						<tr>
							<td colspan = "2" align = "center"><input type = "submit" value = "删除">
